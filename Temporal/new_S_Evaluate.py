...
# ===================== 读取数据 =======================
df = pd.read_csv(r'Time_KL_北京市station_换电数据_flow_2_del_normalized.csv')
...
results_df.to_csv('Time_KL_成都_北京station评估.csv', index=False)
print("评估完成，结果保存至 Time_KL_成都_北京station评估.csv")
